...
function Constant(){
    ...
    this.settings = {
        ...
        searchMagicalCoderIdRule:{
            firstSearch:function(elem){
                if(elem.is(".ant-card-head") || elem.is(".ant-card-body")){
                    return elem.parent();
                }
                return null;
            },
    ...
    this.components = [
        ...
        },
        {
            ...
            children:[
                ...
                {name:"面包屑",icon:"ri-delete-back-line",html:"<a-breadcrumb><a-breadcrumb-item>Home</a-breadcrumb-item><a-breadcrumb-item><a href=''>Application Center</a></a-breadcrumb-item><a-breadcrumb-item><a href=''>Application List</a></a-breadcrumb-item><a-breadcrumb-item>An Application</a-breadcrumb-item></a-breadcrumb>"},
                {
                    name:"下拉菜单",
                    icon:"",
                ...
                {name:"分页",icon:"ri-pages-line",html:"<a-pagination v-model='current' :total='50' showlessitems=''></a-pagination>"},
                {name:"步骤条",icon:"ri-number-1",html:"<a-steps :current='1'><a-step></a-step><a-step title='In Progress' subtitle='Left 00:00:08' description='This is a description.'></a-step><a-step title='Waiting' description='This is a description.'></a-step></a-steps>"},
            ]
        },
        {
            name:"数据展示",
    ...
    */
    this.tagClassMapping = {
        ...
        "a-col":           {name:"列",canZoom:true,assistZoom:true,       dragInto:true,       duplicate:true,assistDuplicate:true,duplicateAttr:[],        copy:false,      paste:true,  canDelete:true,assistDelete:true,onlyParents:["a-row"] ,bind:{"v-text":'""',"v-html":'""',"v-for":"[]"}  ,dblClickChange:{type:"text"} },
        ...
        "a-checkbox-group":{name:"多选框组",treeExtraName:{attr:["v-model"]},    dragInto:true,      duplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,     onlyChildren:["a-checkbox"],  bind:{"v-model":"[]"}  ,assistAdd:true,addOneItems:[{"":[{html:"<a-checkbox value='1'>多选项1</a-checkbox>",focus:false}]}]                    },
        ...
        "a-form-item":     {name:"表单条目",canZoom:true,assistZoom:true,treeExtraName:{attr:["label"]},   dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,assistDelete:true,     onlyParents:["a-form","a-col"], dblClickChange:{type:'attr',attrName:"label",contenteditableElemFn:function(elem){ return elem.find(".ant-form-item-label").find("label")},attrValueFn:function(contenteditableElem){var label = contenteditableElem.find(".ant-form-item-label").find("label");if(label.length>0){return label.text()}else{return contenteditableElem.text()}},} },
        /*表单*/
        ...
        "a-button":        {primary:0,name:"按钮",treeExtraName:{attr:[],text:true},     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,dblClickChange:{type:'text'}      },
        "a-radio":         {name:"单选框",treeExtraName:{attr:[],text:true},    dragInto:false,     duplicate:true,duplicateAttr:["value"], copy:true,      paste:false,   canDelete:true,      onlyParents:["a-radio-group"],dblClickChange:{type:"text"}  },
        "a-radio-button":  {name:"单选按钮",   dragInto:false,    duplicate:true,duplicateAttr:[],         copy:true,      paste:false,    canDelete:true     },
        "a-checkbox":      {name:"多选框",treeExtraName:{attr:[],text:true},    dragInto:false,     duplicate:true,duplicateAttr:["value"],         copy:true,      paste:false,   canDelete:true,     onlyParents:["a-checkbox-group"] ,dblClickChange:{type:"text"}},
        ...
        "a-select":        {name:"下拉框",treeExtraName:{attr:["v-model"]},    dragInto:false,     duplicate:true,assistDuplicate:false,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,assistDelete:false,    onlyChildren:["a-select-option"], bind:{"v-model":'""'}, assistAdd:false,addOneItems:[{"":[{html:"<a-select-option value='1'>选择1</a-select-option>",focus:true}]}],tmpWrapTag:"div"       },
        ...
        "a-tag":           {name:"标签",      dragInto:false,    duplicate:true,                          copy:true,      paste:false,  canDelete:true   ,dblClickChange:{type:'text'}},
        "a-checkable-tag":           {name:"可点标签",      dragInto:false,    duplicate:true,                          copy:true,      paste:false,  canDelete:true, bind:{"v-model":"true"},dblClickChange:{type:'text'}   },
        "a-card":           {name:"卡片",canZoom:true,assistZoom:true,treeExtraName:{attr:["title"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:"attr",attrName:"title",attrValueFn:function(elem){return elem.find(".ant-card-head").text();}},contenteditableElemFn:function(elem){return elem.find(".ant-card-head");}   },
        ...
        "a-collapse-panel": {name:"折叠条目",treeExtraName:{attr:["header"]},canZoom:true,assistZoom:true,dragInto:true,  duplicate:true,assistDuplicate:true,duplicateAttr:["key"],   copy:true,      paste:false,  canDelete:true,assistDelete:true,onlyParents:["a-collapse"] ,dblClickChange:{type:'attr',attrName:'header',contenteditableElemFn:function(elem){return elem.find(".ant-collapse-header")}}  },
        ...
        /*echarts*/
        "mc-echarts-bar":{name:"条形图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-line":{name:"线性图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,duplicateAttr:['id'],afterDragDrop:{refresh:true},afterResize:{refresh:true} },
        "mc-echarts-pie":{name:"饼图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-scatter":{name:"散点图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-radar":{name:"雷达图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-k":{name:"K线图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-tree":{name:"树图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-funnel":{name:"漏斗图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-gauge":{name:"仪表盘",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-boxplot":{name:"盒须图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-sunburst":{name:"旭日图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-treemap":{name:"矩阵树图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-pictorialbar":{name:"象形柱图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-sankey":{name:"桑基图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-parallel":{name:"平行坐标",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true},tmpWrapTag:"div",tmpWrapShade:true},
        "mc-echarts-themeriver":{name:"主题河流",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},
        "mc-echarts-dataset":{name:"数据集图",dragInto:false,duplicate:true,assistDuplicate:true, copy:true,      paste:false,    canDelete:true,assistDelete:true,afterDragDrop:{refresh:true},afterResize:{refresh:true}},

        "a":     {primary:0,name:"超链接",treeExtraName:{attr:['id','name'],text:true},dragInto:false,  duplicate:true,   copy:true,      paste:false,  canDelete:true,dblClickChange:{type:"text"}    },
        "i":{primary:0,name:"图标",   dragInto:false, duplicate:true,duplicateAttr:[],         copy:true,      paste:false,    canDelete:true    ,dblClickChange:{type:"text"} },
        "span":{primary:0,name:"文字",   dragInto:false, duplicate:true,duplicateAttr:[],         copy:true,      paste:false,    canDelete:true  ,dblClickChange:{type:"text"}   },
        "p":    {name:"段落",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true   ,dblClickChange:{type:"text"} },
        "small":  {name:"小字",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:"text"}  },
        "mark":   {name:"高亮",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:"text"}  },
        "del":    {name:"中划线",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:"text"}   },
        "u":      {name:"下划线",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:"text"}   },
        "em":     {name:"斜体",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true,dblClickChange:{type:"text"}    },
        "strong": {name:"加粗",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true,dblClickChange:{type:"text"}    },
        ...
        "th": {name:"表格标题",dragInto:true,assistDelete:false,assistAdd:false,assistDuplicate:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:false,  canDelete:true,onlyParents:['tr'] ,dblClickChange:{type:'text'}   },
        "td": {name:"单元格",dragInto:true,assistDelete:false,assistAdd:false,assistDuplicate:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:false,  canDelete:true,onlyParents:['tr']   ,dblClickChange:{type:'text'} },
        ...
        "a-breadcrumb-item":{"name":"子面包屑","dragInto":true,"duplicate":true,"copy":false,"paste":true,"canDelete":true,"onlyParents":["a-breadcrumb"],dblClickChange:{type:'text',contenteditableElemFn:function(elem){return elem.find(".ant-breadcrumb-link")}}},
        ...
        "a-page-header":{"name":"页头","dragInto":false,"duplicate":true,"assistDuplicate":true,"copy":true,"paste":true,"canDelete":true,"assistDelete":true,"assistZoom":true,"canZoom":true,"bind":{":ghost":"true",":breadcrumb":"null"},dblClickChange:{type:"attr",attrName:"title",contenteditableElemFn:function(elem){return elem.find(".ant-page-header-heading-title")}}},
        ...
        /*lxb*/
        "a-result":{"name":"结果","dragInto":false,"duplicate":true,"assistDuplicate":true,"copy":true,"paste":true,"canDelete":true,"assistDelete":true,"assistZoom":true,"canZoom":true,"bind":{":icon":"null",":extra":"null"},dblClickChange:{type:'attr',attrName:'title',contenteditableElemFn:function(elem){return elem.find(".ant-result-title")}}},
        ...
        "a-empty":{"name":"空状态","dragInto":false,"duplicate":true,"assistDuplicate":true,"copy":true,"paste":true,"canDelete":true,"assistDelete":true,"assistZoom":true,"canZoom":true,"bind":{":description":'""',":image-style":"null",":image":'"false"'}},
        ...
        "a-list-item":{"name":"子列表","dragInto":true,"duplicate":true,"assistDuplicate":true,"copy":false,"paste":true,"canDelete":true,"assistDelete":true,"onlyParents":["a-list"],dblClickChange:{type:'text'}},
        ...
        [
            {
                ...
                content:{
                    ...
                    "mc-root":[
                        ...
                        {type:this.type.SLIDER,clearAttr:true       ,oneLine:false ,attrName:'mcnetline'       ,change:this.change.ATTR    ,title:'网格',tooltip:"",extra:{min:0,max:200,step:10}},
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.STYLE,attrName:'height',title:'高度',tooltip:'height',extra:{min:0,max:1000}}
                    ],
                    "a-row":[
            ...
            },
            {
                ...
                content:{
                    "a-empty":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'图片样式',tooltip:'属性名::image-style<br>说明:图片样式<br>类型:CSSProperties',attrName:':image-style',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置显示图片，为 string 时表示自定义图片地址',tooltip:'属性名::image<br>说明:设置显示图片，为 string 时表示自定义图片地址<br>类型:string | v-slot<br>默认值:false',attrName:':image',extendKey:"variable"}
                    ],
                    "a-list":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'列表栅格配置',tooltip:'属性名::grid<br>说明:列表栅格配置<br>类型:object',attrName:':grid',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当卡片内容还在加载中时，可以用loading展示一个占位',tooltip:'属性名::loading<br>说明:当卡片内容还在加载中时，可以用 loading 展示一个占位<br>类型:boolean|object<br>默认值:false',attrName:':loading',extendKey:"variable"},
                        {type:this.type.CHECKBOX,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'状态',options:[{n:":pagination",t:"不显示对应的pagination配置",c:true,u:false,dv:false},],extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'列表数据源',tooltip:'属性名::data-source<br>说明:列表数据源<br>类型:any[]',attrName:':data-source',extendKey:"variable"}
                    ],
                    "a-list-item-meta":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'列表元素的描述内容',tooltip:'属性名::description<br>说明:列表元素的描述内容<br>类型:string|slot',attrName:':description',extendKey:"variable"}
                    ],
                    "a-mentions":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置值',tooltip:'属性名:v-model<br>说明:设置值<br>类型:string',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置触发关键字',tooltip:'属性名::prefix<br>说明:设置触发关键字<br>类型:string | string[]<br>默认值:@',attrName:':prefix',extendKey:"variable"}
                    ],
                    "a-cascader":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'指定选中项',tooltip:'属性名:v-model<br>说明:指定选中项<br>类型:string[] | number[]',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'默认的选中项',tooltip:'属性名::default-value<br>说明:默认的选中项<br>类型:string[] | number[]<br>默认值:[]',attrName:':default-value',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'选择后展示的渲染函数,可使用 slot="displayRender" 和 slot-scope="{labels, selectedOptions}"',tooltip:'属性名::display-render<br>说明:选择后展示的渲染函数,可使用 slot=displayRender 和 slot-scope={labels, selectedOptions}<br>类型:({labels, selectedOptions}) => vNode<br>默认值:labels => labels.join( / )',attrName:':display-render',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义 options 中 label name children 的字段',tooltip:'属性名::field-names<br>说明:自定义 options 中 label name children 的字段<br>类型:object<br>默认值:{ label: label, value: value, children: children }',attrName:':field-names',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单渲染父节点。默认渲染到 body 上，如果你遇到菜单滚动定位问题，试试修改为滚动的区域，并相对其定位。',tooltip:'属性名:get-popup-container<br>说明:菜单渲染父节点。默认渲染到 body 上，如果你遇到菜单滚动定位问题，试试修改为滚动的区域，并相对其定位。<br>类型:Function(triggerNode)<br>默认值:() => document.body',attrName:'get-popup-container',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'用于动态加载选项，无法与 showSearch 一起使用',tooltip:'属性名::load-data<br>说明:用于动态加载选项，无法与 showSearch 一起使用<br>类型:(selectedOptions) => void',attrName:':load-data',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'可选项数据源',tooltip:'属性名::options<br>说明:可选项数据源<br>类型:object',attrName:':options',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'在选择框中显示搜索框',tooltip:'属性名::show-search<br>说明:在选择框中显示搜索框<br>类型:boolean<br>默认值:false',attrName:':show-search',extendKey:"variable"}
                    ],
                    "a-tree-select":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'下拉菜单的样式',tooltip:'属性名::dropdown-style<br>说明:下拉菜单的样式<br>类型:object',attrName:':dropdown-style',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'根据输入项进行筛选',tooltip:'属性名:filter-tree-node<br>说明:是否根据输入项进行筛选，默认用 treeNodeFilterProp 的值作为要筛选的 TreeNode 的属性值<br>类型:boolean|Function(inputValue: string, treeNode: TreeNode) (函数需要返回 bool 值)<br>默认值:Function',attrName:'filter-tree-node',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单渲染父节点。。',tooltip:'属性名:get-popup-container<br>说明:菜单渲染父节点。默认渲染到 body 上，如果你遇到菜单滚动定位问题，试试修改为滚动的区域，并相对其定位。<br>类型:Function(triggerNode)<br>默认值:() => document.body',attrName:'get-popup-container',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'异步加载数据',tooltip:'属性名::load-data<br>说明:异步加载数据<br>类型:function(node)',attrName:':load-data',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'隐藏 tag 时显示的内容',tooltip:'属性名:max-tag-placeholder<br>说明:隐藏 tag 时显示的内容<br>类型:slot/function(omittedValues)',attrName:'max-tag-placeholder',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'定义选中项回填的方式。',tooltip:'属性名::show-checked-strategy<br>说明:定义选中项回填的方式。TreeSelect.SHOW_ALL: 显示所有选中节点(包括父节点). TreeSelect.SHOW_PARENT: 只显示父节点(当父节点下所有子节点都选中时). 默认只显示子节点.<br>类型:enum{TreeSelect.SHOW_ALL, TreeSelect.SHOW_PARENT, TreeSelect.SHOW_CHILD }<br>默认值:TreeSelect.SHOW_CHILD',attrName:':show-checked-strategy',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'treeNodes 数据（value 在整个树范围内唯一）',tooltip:'属性名::tree-data<br>说明:treeNodes 数据，如果设置则不需要手动构造 TreeNode 节点（value 在整个树范围内唯一）<br>类型:array<{value, label, children, [disabled, disableCheckbox, selectable]}><br>默认值:[]',attrName:':tree-data',extendKey:"variable"}
                    ],

                    "a-progress":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'百分比',tooltip:'属性名::percent<br>说明:百分比<br>类型:number<br>默认值:0',attrName:':percent',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'显示进度数值',tooltip:'属性名::show-info<br>',attrName:':show-info',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'已完成的分段百分比',tooltip:'属性名::success-percent<br>说明:已完成的分段百分比<br>类型:number<br>默认值:0',attrName:':success-percent',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'内容的模板函数',tooltip:'属性名::format<br>说明:内容的模板函数<br>类型:function(percent, successPercent) | v-slot:format=percent, successPercent<br>默认值:percent => percent + %',attrName:':format',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'仪表盘进度条画布宽度，单位 px',tooltip:'属性名::width<br>说明:仪表盘进度条画布宽度，单位 px<br>类型:number<br>默认值:132',attrName:':width',extendKey:"variable"}
                    ],
                    "a-spin":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'延迟显示加载效果的时间（防止闪烁）',tooltip:'属性名::delay<br>说明:延迟显示加载效果的时间（防止闪烁）<br>类型:number (毫秒)',attrName:':delay',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'加载指示符',tooltip:'属性名::indicator<br>说明:加载指示符<br>类型:vNode | slot',attrName:':indicator',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'是否为加载中状态',tooltip:'属性名::spinning<br>说明:是否为加载中状态<br>类型:boolean<br>默认值:true',attrName:':spinning',extendKey:"variable"}
                    ],

                    "a-pagination":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前页数',tooltip:'属性名:current(v-model)<br>说明:当前页数<br>类型:number',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'默认的当前页数',tooltip:'属性名::default-current<br>说明:默认的当前页数<br>类型:number<br>默认值:1',attrName:':default-current',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'用于自定义页码的结构，可用于优化 SEO',tooltip:'属性名::item-render<br>说明:用于自定义页码的结构，可用于优化 SEO<br>类型:(page, type: page | prev | next, originalElement) => vNode',attrName:':item-render',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'指定每页可以显示多少条',tooltip:'属性名::page-size-options<br>说明:指定每页可以显示多少条<br>类型:string[]<br>默认值:[10, 20, 30, 40]',attrName:':page-size-options',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'用于显示数据总量和当前数据顺序',tooltip:'属性名::show-total<br>说明:用于显示数据总量和当前数据顺序<br>类型:Function(total, range)',attrName:':show-total',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'数据总数',tooltip:'属性名::total<br>说明:数据总数<br>类型:number<br>默认值:0',attrName:':total',extendKey:"variable"}
                    ],
                    "a-steps":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'指定当前步骤，从 0 开始记数。在子 Step 元素中，可以通过 status 属性覆盖状态, 1.5.0 后支持 v-model',tooltip:'属性名:current (v-model)<br>说明:指定当前步骤，从 0 开始记数。在子 Step 元素中，可以通过 status 属性覆盖状态, 1.5.0 后支持 v-model<br>类型:number<br>默认值:0',attrName:'v-model',extendKey:"variable"},
                    ],
                    "a-step":[
                    ],
                    "a-auto-complete":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自动完成的数据源',tooltip:'属性名::data-source<br>说明:自动完成的数据源<br>类型:slot | DataSourceItemType[]',attrName:':data-source',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'是否根据输入项进行筛选。当其为一个函数时，会接收 inputValue option 两个参数，当 option 符合筛选条件时，应返回 true，反之则返回 false。',tooltip:'属性名::filter-option<br>说明:是否根据输入项进行筛选。当其为一个函数时，会接收 inputValue option 两个参数，当 option 符合筛选条件时，应返回 true，反之则返回 false。<br>类型:boolean or function(inputValue, option)<br>默认值:true',attrName:':filter-option',extendKey:"variable"}
                    ],
                    "a-dropdown":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单渲染父节点',tooltip:'属性名:get-popup-container<br>说明:菜单渲染父节点<br>类型:Function(triggerNode)<br>默认值:() => document.body',attrName:'get-popup-container',extendKey:"variable"},
                        {type:this.type.SELECT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单弹出位置',attrName:'placement',options:[{"bottomLeft":"按钮左侧","bottomCenter":"按钮中央","bottomRight":"按钮右侧","topLeft":"顶部左侧","topCenter":"顶部中央","topRight	":"顶部右侧"}],extendKey:"variable"},
                        {type:this.type.CHECKBOX_ARRAY,clearAttr:true,oneLine:true,change:this.change.ATTR,attrName:'trigger',title:'触发下拉的行为',tooltip:"触发下拉的行为, 移动端不支持 hover",options:[{"c":"click","n":"","t":"点击","u":""},{"c":"hover","n":"","t":"悬浮","u":""},{"c":"contextmenu","n":"","t":"右键菜单","u":""}],extendKey:"variable"},
                    ],
                    "a-menu":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'初始展开的 SubMenu 菜单项 key 数组',tooltip:'属性名::default-open-keys<br>说明:初始展开的 SubMenu 菜单项 key 数组<br>类型:',attrName:':default-open-keys',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'初始选中的菜单项 key 数组',tooltip:'属性名::default-selected-keys<br>说明:初始选中的菜单项 key 数组<br>类型:string[]',attrName:':default-selected-keys',extendKey:"variable"},
                        {type:this.type.CHECKBOX,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'状态' ,options:[{n:"inline-collapsed",t:"inline 时菜单是否收起状态",c:true,u:false}],extendKey:"variable"},
                        {type:this.type.SELECT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单类型',attrName:'mode',options:[{"vertical":"垂直模式","horizontal":"水平模式","inline":"内嵌模式"}],extendKey:"variable"},
                        {type:this.type.SELECT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'主题颜色',attrName:'theme',options:[{"dark":"黑色模式","light":"白色模式"}],extendKey:"variable"},
                    ],
                    "a-menu-item":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'唯一标志',tooltip:'属性名::key<br>说明:唯一标志<br>类型:string',attrName:':key',extendKey:"variable"}
                    ],
                    "a-sub-menu":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'唯一标志',tooltip:'属性名::key<br>说明:唯一标志<br>类型:string',attrName:':key',extendKey:"variable"}
                    ],
                    "a-menu-item-group":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'分组标题',tooltip:'属性名:title<br>说明:分组标题<br>类型:string||function|slot',attrName:'title',extendKey:"variable"}
                    ],
                    "a-page-header":[
                        {type:this.type.CHECKBOX,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'状态' ,options:[{n:"ghost",t:"pageHeader 的类型，将会改变背景颜色",c:true,u:false,dv:true}],extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'面包屑的配置',tooltip:'属性名::breadcrumb<br>说明:面包屑的配置<br>类型:breadcrumb',attrName:':breadcrumb',extendKey:"variable"},
                    ],

                    "a-anchor":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'固定模式',tooltip:'属性名::affix<br>说明:固定模式<br>类型:boolean<br>默认值:true',attrName:':affix',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义高亮的锚点',tooltip:'属性名::get-current-anchor<br>说明:自定义高亮的锚点<br>类型:() => string',attrName:':get-current-anchor',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'锚点滚动偏移量，默认与 offsetTop 相同，例子',tooltip:'属性名::target-offset<br>说明:锚点滚动偏移量，默认与 offsetTop 相同，例子<br>类型:number<br>默认值:offsetTop',attrName:':target-offset',extendKey:"variable"}
                    ],
                    "a-config-provider":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置 Content Security Policy 配置',tooltip:'属性名::csp<br>说明:设置 Content Security Policy 配置<br>类型:{ nonce: string }',attrName:':csp',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义组件空状态。参考 空状态',tooltip:'属性名:render-empty<br>说明:自定义组件空状态。参考 空状态<br>类型:slot-scope | Function(componentName: string): VNode',attrName:'render-empty',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'弹出框（Select, Tooltip, Menu 等等）渲染父节点，默认渲染到 body 上。',tooltip:'属性名::get-popup-container<br>说明:弹出框（Select, Tooltip, Menu 等等）渲染父节点，默认渲染到 body 上。<br>类型:Function(triggerNode, dialogContext)<br>默认值:() => document.body',attrName:':get-popup-container',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'语言包配置，语言包可到 ant-design-vue/es/locale 目录下寻找',tooltip:'属性名::locale<br>说明:语言包配置，语言包可到 ant-design-vue/es/locale 目录下寻找<br>类型:object',attrName:':locale',extendKey:"variable"}
                    ],


                    "a-radio-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:true        ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:'v-model',extendKey:"variable"},
                    ],
                    "a-checkbox-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:true        ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:'v-model',extendKey:"variable"},
                    ],
                    "a-input":[
                        {type:this.type.TEXT       ,clearAttr:true     ,oneLine:true         ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:'v-model' ,validate:{"^[a-zA-Z][a-zA-Z0-9_]*$":"请输入字母数字或者下划线"} ,extendKey:"variable"},
                    ...
                    "a-tabs":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'选中选项卡变量名*'    ,attrName:'v-model',extendKey:"variable"},
                    ],
                    "a-tab-pane":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'选项卡别名'    ,tooltip:'与选项卡绑定值 value 对应的标识符，表示选项卡别名'    ,attrName:'name',extendKey:"variable"},
                    ]
                    ,"a-collapse":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'当前激活的面板'   ,attrName:'v-model',extendKey:"variable"},
                    ]
                    ,"a-badge":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'变量名'   ,attrName:':count',extendKey:"variable"},
                    ]
                    ,"a-avatar":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'地址变量名'   ,attrName:':src',extendKey:"variable"},
                    ],
                    "a-calendar":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'变量名'   ,attrName:'v-model',extendKey:"variable"},
                    ],
                    "a-tag":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'变量名'   ,attrName:'v-model',extendKey:"variable"},
                    ],
                    ...
                    "a-locale-provider":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'语言'   ,attrName:':locale',extendKey:"variable"},
                    ],
                    "a-affix":[
                         {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置Affix需要监听其滚动事件的元素',tooltip:'属性名::target<br>说明:设置 Affix 需要监听其滚动事件的元素，值为一个返回对应 DOM 元素的函数<br>类型:() => HTMLElement<br>默认值:() => window',attrName:':target',extendKey:"variable"}
                    ],
                    "a-breadcrumb":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'router的路由栈信息',tooltip:'属性名::routes<br>说明:router 的路由栈信息<br>类型:routes[]',attrName:':routes',extendKey:"variable"}
                    ],
                    "a-statistic":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'数值精度',tooltip:'属性名::precision<br>说明:数值精度<br>类型:number',attrName:':precision',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置数值的前缀',tooltip:'属性名::prefix<br>说明:设置数值的前缀<br>类型:string | v-slot',attrName:':prefix',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置数值的后缀',tooltip:'属性名::suffix<br>说明:设置数值的后缀<br>类型:string | v-slot',attrName:':suffix',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'数值内容',tooltip:'属性名::value<br>说明:数值内容<br>类型:string | number',attrName:':value',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'设置数值的样式',tooltip:'属性名::value-style<br>说明:设置数值的样式<br>类型:style',attrName:':value-style',extendKey:"variable"}
                    ],
                    "a-statistic-countdown":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'数值内容',tooltip:'属性名::value<br>说明:数值内容<br>类型:number | moment',attrName:':value',extendKey:"variable"}
                    ],
                    "a-timeline":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'节点排序',tooltip:'属性名::reverse<br>说明:节点排序<br>类型:boolean<br>默认值:false',attrName:':reverse',extendKey:"variable"}
                    ],
                    "a-modal":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'是否显示',tooltip:'是否显示：v-model true|false',attrName:'v-model',extendKey:"variable"},
                    ...
                    "a-tree":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'treeNodes数据',tooltip:'属性名::tree-data<br>说明:treeNodes 数据，如果设置则不需要手动构造 TreeNode 节点（key 在整个树范围内唯一）<br>类型:array<{key, title, children, [disabled, selectable]}><br>默认值:--',attrName:':tree-data',extendKey:"variable"},
            ...
            },
            {
                ...
                content:{
                    ...
                    "a-checkbox-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'切换触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"新状态的值"}]},
                    ],
                    "a-radio-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'切换触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event事件对象"}]},
                    ],
                    "a-input":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event事件对象"}]},
                        /*{type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'按下回车的回调'     ,attrName:'@press-enter',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},*/
                    ],
                    "a-input-number":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"新状态的值"}]},
                        /*{type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'按下回车的回调'     ,attrName:'@press-enter',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},*/
                    ],
                    "a-rate":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'离开焦点触发事件'     ,attrName:'@blur',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'获取焦点触发事件'     ,attrName:'@focus',extendKey:"method",extend:true,functionParams:[]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'清空内容触发事件'     ,attrName:'@clear',extendKey:"method",extend:true,functionParams:[]},
                    ],
                    "a-select":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'选中触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"},{name:"option",title:"属性"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'取消选中触发事件'     ,attrName:'@deselect',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"},{name:"option",title:"属性"}]},
                    ],
                    "a-slider":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'选中触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},
                        /*{type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'取消选中触发事件'     ,attrName:'@after-change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},*/
                    ],
                    "el-switch":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变化时触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"checked",title:"新状态的值"},{name:"e",title:"event事件对象"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'点击时触发事件'     ,attrName:'@click',extendKey:"method",extend:true,functionParams:[{name:"checked",title:"新状态的值"},{name:"e",title:"event事件对象"}]},
                    ],
                }
            }
        ]
