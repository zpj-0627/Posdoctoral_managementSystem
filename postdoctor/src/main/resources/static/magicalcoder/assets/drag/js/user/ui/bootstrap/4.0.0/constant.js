...
function Constant(){
    ...
    this.components = [
        ...
        },
        {
            ...
            children:[
                ...
                {"name":"按钮","icon":"assets/drag/img/left/btn1.png","html":"<button type='button' class='btn  btn-info'>按钮</button>"},
    ...
    */    var formItemOnlyParents = this.rowColBuild().cols();
    ...
    this.tagClassMapping = {
        ...
        "div":    {primary:-1,name:"块",dragInto:true,  duplicate:true,duplicateAttr:["id"],assistDuplicate:true,       copy:true,      paste:true,  canDelete:true   ,dblClickChange:{type:"text"} },
        "span":    {primary:-1,name:"行内",dragInto:false,  duplicate:true,duplicateAttr:["id"],assistDuplicate:true,       copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:"text"}  },
        "a":    {primary:0,name:"超链接",dragInto:false,  duplicate:true,duplicateAttr:[],       copy:true,      paste:false,  canDelete:true  ,dblClickChange:{type:"text"}  },
        ...
        "var":     {name:"变量",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:"text"}   },
        ...
        "select":{name:"下拉框",treeExtraName:{attr:['id','name'],text:false},dragInto:false,duplicate:true, copy:true,      paste:false,    canDelete:true,onlyChildren:["option"],tmpWrapTag:'div',tmpWrapShade:true},
        ...
        "type=radio":{name:"单选框",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["value"], copy:true,      paste:false,    canDelete:true },
        "type=checkbox":{primary:0,name:"复选框",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["value"], copy:true,      paste:false,    canDelete:true},
        "type=button":{primary:0,name:"按钮",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["id"], copy:true,      paste:false,    canDelete:true,dblClickChange:{type:"text"}},
        "button":{primary:0,name:"按钮",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["id"], copy:true,      paste:false,    canDelete:true,dblClickChange:{type:"text"}},
        "btn":{primary:0,name:"按钮",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["id"], copy:true,      paste:false,    canDelete:true,dblClickChange:{type:"text"}},
        ...
        "card-header":          {name:"卡片头",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:true,    duplicate:false,assistDuplicate:false,                           copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:'text'}    },
        ...
        "card-text":          {name:"卡片文字",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:false,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:'text'}   },
        "card-footer":          {name:"卡片底部",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:false,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:'text'}   },
        ...
        "alert":     {name:"警示",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true ,dblClickChange:{type:'text'}   },
        "alert-link":     {name:"警示链接",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:false,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:'text'}  },
        ...
        "breadcrumb-item":     {name:"面包屑条目",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:'text'}  },
        ...
        "h2":{name:"二级标题",canZoom:true,assistZoom:true,treeExtraName:{attr:["id"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true  ,dblClickChange:{type:'text'}  },
        ...
        "label":{name:"标签",canZoom:false,assistZoom:false,treeExtraName:{attr:["id"]},   dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true   ,dblClickChange:{type:'text'} },
        "badge":{name:"徽章",canZoom:false,assistZoom:false,treeExtraName:{attr:["id"]},   dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true    },
    }
