...
function Constant(){
        ...
        },
        {
            ...
            children:[
                ...
                },
                {
                    name:"图片",
                    icon:"ri-image-fill",
                    html:"<el-image style='width:50%;height:500px' src='img.jpg'></el-image>"
                },{
                    name:"图标",
    ...
    */
    this.tagClassMapping = {
        ...
        "el-col":           {name:"列",canZoom:true,assistZoom:true,       dragInto:true,       duplicate:true,assistDuplicate:true,duplicateAttr:[],        copy:false,      paste:true,  canDelete:true,assistDelete:true,onlyParents:["el-row"] ,bind:{"v-text":'""',"v-html":'""',"v-for":"[]"},dblClickChange:{type:"text"} },
        ...
        "el-form-item":     {name:"表单条目",canZoom:true,assistZoom:true,treeExtraName:{attr:["label"]},   dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,assistDelete:true,     onlyParents:["el-form","el-col"], dblClickChange:{type:'attr',attrName:"label",contenteditableElemFn:function(elem){ return elem.find(".el-form-item__label")},}  },
        /*表单*/
        ...
        "el-button":        {primary:0,name:"按钮",treeExtraName:{attr:[],text:true},     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,dblClickChange:{type:"text"}      },
        "el-radio":         {name:"单选框",treeExtraName:{attr:[],text:true},    dragInto:false,     duplicate:true,duplicateAttr:["label"], copy:true,      paste:false,   canDelete:true,      onlyParents:["el-radio-group"]  ,dblClickChange:{type:"text"} },
        "el-radio-button":  {name:"单选按钮",   dragInto:false,    duplicate:true,duplicateAttr:[],         copy:true,      paste:false,    canDelete:true     },
        "el-link":          {name:"链接",     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,dblClickChange:{type:"text"}      },
        "el-checkbox":      {name:"多选框",treeExtraName:{attr:[],text:true},    dragInto:false,     duplicate:true,duplicateAttr:["label"],         copy:true,      paste:false,   canDelete:true,     onlyParents:["el-checkbox-group"],dblClickChange:{type:"text"} },
        ...
        "show-password=true":{primary:1,name:"密码框",treeExtraName:{attr:["v-model"]},    dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,   bind:{"v-model":'""'} ,tmpWrapTag:'div',tmpWrapType:0,tmpWrapShade:true},
        ...
        "el-tab-pane":      {name:"标签子项",canZoom:true,assistZoom:true,treeExtraName:{attr:["label"]},  dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:["name"],    copy:false,     paste:true,   canDelete:true,assistDelete:true,dblClickChange:{type:"text"}    },
        ...
        "el-tag":           {name:"标签",      dragInto:false,    duplicate:true,                          copy:true,      paste:false,  canDelete:true,dblClickChange:{type:"text"}    },
        ...
        "el-card":          {name:"卡片",canZoom:true,assistZoom:true,treeExtraName:{attr:["header"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true,dblClickChange:{type:"attr",attrName:"header",attrValueFn:function(elem){return elem.find(".el-card__header").text();}},contenteditableElemFn:function(elem){return elem.find(".el-card__header");}    },
        ...
        "el-image":         {name:"图片",treeExtraName:{attr:[":src"]}, dragInto:false,    duplicate:true,copy:true,      paste:false,  canDelete:true ,bind:{":src":'""',':preview-src-list':'[""]'} ,tmpWrapTag:'div',tmpWrapShade:true   },
        ...
        "el-menu-item":     {name:"菜单条目",dragInto:false,  duplicate:true,duplicateAttr:["index"],   copy:true,      paste:false,  canDelete:true ,onlyParents:["el-menu","el-submenu"] ,dblClickChange:{type:"text"}   },
        ...
        "el-breadcrumb-item":{name:"面包屑条目",dragInto:false,  duplicate:true,assistDuplicate:true,   copy:true,      paste:false,  canDelete:true ,onlyParents:["el-breadcrumb"],dblClickChange:{type:"text"}    },
        "el-page-header":   {name:"页头",dragInto:false,  duplicate:true,assistDuplicate:true,   copy:true,      paste:false,  canDelete:true,dblClickChange:{type:"attr",attrName:"content",contenteditableElemFn:function(elem){return elem.find(".el-page-header__content")}}    },
        ...
        "el-step":          {name:"步骤条目",dragInto:false,  duplicate:true,assistDuplicate:true,   copy:true,      paste:false,  canDelete:true,assistDelete:true,onlyParents:["el-steps"],dblClickChange:{type:"attr",attrName:"title",attrValueFn:function(elem){return elem.find(".el-step__main").text();},contenteditableElemFn:function(elem){return elem;}}    },
        ...
        "el-collapse-item": {name:"折叠条目",treeExtraName:{attr:["title"]},canZoom:true,assistZoom:true,dragInto:true,  duplicate:true,assistDuplicate:true,duplicateAttr:["name"],   copy:true,      paste:false,  canDelete:true,assistDelete:true,onlyParents:["el-collapse"],dblClickChange:{type:'attr',attrName:'title',contenteditableElemFn:function(elem){return elem.find(".el-collapse-item__header")}}   },
        ...
        /*template不要使用tmpWrapTag 否则table下按钮无法显示*/
        "template":{name:"Template模板",dragInto:true,duplicate:false, copy:true,      paste:true,    canDelete:true},
        "mc-window":{name:"窗体",dragInto:true,duplicate:false, copy:false,      paste:true,    canDelete:true,assistDelete:true,dblClickChange:{type:"text"}},
 ...
 /*echarts*/
        ...
        "span":{primary:0,name:"行内",   dragInto:false, duplicate:true,duplicateAttr:[],         copy:true,      paste:false,    canDelete:true ,dblClickChange:{type:"text"}    },
        ...
        "el-alert":        {name:"警告",treeExtraName:{attr:[],text:true},     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,dblClickChange:{type:'text'}      },
    ...
    {//兼容下ie ie系列无法拖拽普通的input之类的控件，咱们在此加上tmpShade
        if(APPLICATION_ENV['addTmpShadeWhileIe']){
            APPLICATION_ENV.addTmpShadeWhileIe(this.tagClassMapping,['el-input','el-date-picker','el-link'])
        }
    }
    //绑定通用v-for
        ...
        [
            {
                ...
                content:{
                    ...
                    "el-input":[
                        ...
                        {type:this.type.CHECKBOX   ,clearAttr:true     ,oneLine:true         ,change:this.change.ATTR    ,title:'状态'                      ,options:[{n:"show-password",t:"",c:true,u:false},{n:"show-word-limit",t:"字数统计",c:true,u:false},{n:"clearable",t:"可清空",c:true,u:false},{n:"disabled",t:"禁用",c:true,u:false},{n:"autosize",t:"自适应",c:true,u:false},{n:"readonly",t:"原生属性，是否只读",c:true,u:false}]},
            ...
            },
            {
                ...
                content:{
                    ...
                    "el-upload":[
                        {type:this.type.TEXT      ,clearAttr:true      ,oneLine:true         ,change:this.change.ATTR    ,title:'变量名*'      ,attrName:':file-list'   ,extendKey:"variable"                                                   },
                    ],
                    "el-rate":[
                        {type:this.type.TEXT      ,clearAttr:true      ,oneLine:true         ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:'v-model'    ,extendKey:"variable"                                                  },
                    ],
                    ...
                    "el-table":[
                        {type:this.type.TEXT      ,clearAttr:true      ,oneLine:true         ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:':data'     ,extendKey:"variable"                                                 },
                    ],
                    "el-table-column":[
                        {type:this.type.TEXT      ,clearAttr:true      ,oneLine:true         ,change:this.change.ATTR    ,title:'变量名*'     ,attrName:'prop'     ,extendKey:"variable"                                                 },
                    ],
                    "el-time-select":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:true     ,change:this.change.ATTR     ,title:'变量名*'    ,attrName:'v-model',extendKey:"variable"},
                    ],
                    ...
                    "el-transfer":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:true     ,change:this.change.ATTR     ,title:'变量名*'    ,attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:true     ,change:this.change.ATTR     ,title:'数据源'    ,attrName:':data',extendKey:"variable"},
                    ],
                    "el-tabs":[
                    ...
                    "el-image":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'图片源'    ,tooltip:'图片源，同原生'    ,attrName:':src',extendKey:"variable"},
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'开启图片预览功能'    ,tooltip:'开启图片预览功能'    ,attrName:':preview-src-list',extendKey:"variable"},
                    ]
                    ,"el-steps":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'当前激活步骤'   ,attrName:':active',extendKey:"variable"},
                    ]
                    ,"el-collapse":[
                    ...
                    ,"el-pagination":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'每页显示条目个数'   ,attrName:':page-size',extendKey:"variable"},
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'总条目数'   ,attrName:':total',extendKey:"variable"},
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'页码按钮的数量',   tooltip:'页码按钮的数量，当总页数超过该值时会折叠',attrName:':pager-count',extendKey:"variable"},
                    ]
                    ,"el-badge":[
                        {type:this.type.TEXT            ,clearAttr:true     ,oneLine:false     ,change:this.change.ATTR     ,title:'变量名'   ,attrName:':value',extendKey:"variable"},
                    ]
                    ,"el-avatar":[
            ...
            },
            {
                ...
                content:{
                    ...
                    "el-radio-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'切换触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前选中的值"}]},
                    ],
                    "el-checkbox-group":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'切换触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"新状态的值"}]},
                    ],
                    "el-input":[
                        ...
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'获取焦点触发事件'     ,attrName:'@focus',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                        ...
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'清空内容触发事件'     ,attrName:'@clear',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                    ],
                    "el-input-number":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'离开焦点触发事件'     ,attrName:'@blur',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'获取焦点触发事件'     ,attrName:'@focus',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"新值"},{name:"oldValue",title:"旧值"}]},
                    ],
                    "el-select":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'离开焦点触发事件'     ,attrName:'@blur',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'获取焦点触发事件'     ,attrName:'@focus',extendKey:"method",extend:true,functionParams:[{name:"e",title:"event"}]},
                    ...
                    "el-slider":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'输入内容触发事件'     ,attrName:'@input',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},
                    ],
                    "el-date-picker":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'离开焦点触发事件'     ,attrName:'@blur',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前实例"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'获取焦点触发事件'     ,attrName:'@focus',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前实例"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前实例"}]},
                    ],
                    "el-color-picker":[
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'变更内容触发事件'     ,attrName:'@change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前值"}]},
                        {type:this.type.TEXT         ,clearAttr:true    ,oneLine:false        ,change:this.change.ATTR    ,title:'面板中当前显示的颜色发生改变时触发事件'     ,attrName:'@active-change',extendKey:"method",extend:true,functionParams:[{name:"value",title:"当前显示的颜色值"}]},
                    ]
                }
            }
        ]
