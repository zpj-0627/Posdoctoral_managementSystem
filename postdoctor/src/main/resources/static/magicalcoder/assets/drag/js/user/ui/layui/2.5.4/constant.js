...
function Constant(){
            ...
            children:[
                {
                    ...
                    html:"<div class='layui-container' style='width: 80%'></div>",
                },{
                    name:"屏幕自适应",
            ...
            children:[
                {
                    ...
                    name:"图片",
                    icon:"ri-image-fill",
                    html:"<img style='width:50%;' src='img.jpg'/>"
                },{
                    name:"按钮",
        ...
        },
        {
            ...
            children:[
                ...
                },
                {
                    ...
                    html:"<span class='magical-coder-layer-contaner'><button class='magicalcoder-layer layui-btn' mc-attr-num-type='1' mc-attr-bool-shade='false' mc-attr-bool-shade-close='true'  mc-attr-str-btn='保存,取消' mc-attr-str-area='800px,400px'>弹窗</button><div class='magicalcoder-layer-content'></div></span>"
                },{
                    name:"标签页",
    ...
    */    var formItemOnlyParents = this.rowColBuild().cols();
    ...
    this.tagClassMapping = {
        ...
        "layui-row":    {name:"行",canZoom:true,assistZoom:true,dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:[],        copy:true,       paste:false,assistDelete:true, canDelete:true, onlyChildren:this.rowColBuild().cols(),   assistAdd:true,addOneItems:[{"":[{html:"<div class='layui-col-md6 layui-col-lg6'></div>",focus:false}]}],afterResize:{widthWucha:true}          },
        /*echarts*/
        ...
        "magicalcoder-layer": {primary:1,name:"弹窗触发按钮",treeExtraName:{attr:['id','name'],text:false},  dragInto:false,    duplicate:false,                           copy:false,      paste:false,  canDelete:true,dblClickChange:{type:"text"}    },
        "magicalcoder-layer-content": {name:"弹窗面板",  dragInto:true,    duplicate:false,                           copy:false,      paste:true,  canDelete:false    },
        "layui-btn":{primary:1,name:"按钮",treeExtraName:{attr:['id','name'],text:true},dragInto:false,duplicate:true, copy:true,      paste:true,    canDelete:true,dblClickChange:{type:"text"}},
        ...
        "type=password":{name:"密码框",treeExtraName:{attr:['id','name'],text:false},dragInto:false,duplicate:true, copy:true,      paste:false,    canDelete:true,tmpWrapTag:'div',tmpWrapType:0,tmpWrapShade:true},
        "type=radio":{name:"单选框",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["value"], copy:true,      paste:false,    canDelete:true,tmpWrapTag:'span',tmpWrapType:1,dblClickChange:{type:"attr",attrName:"title",attrValueFn:function(contenteditableElem){return contenteditableElem.find(".layui-unselect").find("div").text();},textRangeElemFn:function(contenteditableElem){return contenteditableElem.find(".layui-unselect").find("div");}}  },
        "type=checkbox":{primary:0,name:"复选框",treeExtraName:{attr:['id','name','title'],text:false},dragInto:false,duplicate:true,duplicateAttr:["value"], copy:true,      paste:false,    canDelete:true,tmpWrapTag:'span',tmpWrapType:1,dblClickChange:{type:"attr",attrName:"title",attrValueFn:function(contenteditableElem){return contenteditableElem.find(".layui-unselect").find("span").text();},textRangeElemFn:function(contenteditableElem){return contenteditableElem.find(".layui-unselect").find("span");}} },
        ...
        "img":{name:"图片",treeExtraName:{attr:['id','name'],text:false},dragInto:false,duplicate:true, copy:true,      paste:false,    canDelete:true,tmpWrapTag:'span',tmpWrapType:0,tmpWrapShade:true},
        /*dblClickChange 不支持修改 否则双击后有问题*/
        "select":{name:"下拉框",treeExtraName:{attr:['id','name'],text:false},dragInto:false,duplicate:true, copy:true,      paste:false,    canDelete:true,onlyChildren:["option"],assistAdd:true,addOneItems:[{"":[{html:"<option value='1'>新选项</option>",focus:true}]}],tmpWrapTag:'div',tmpWrapType:1,tmpWrapClass:"mc-dragging-select"},
        ...
        "layui-form-label":{name:"标题",treeExtraName:{attr:[],text:true},   dragInto:false, duplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,dblClickChange:{type:"text"} },
        "layui-input-block":{name:"块级区域",canZoom:true,assistZoom:true,   dragInto:true, duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,   assistDelete:true, canDelete:true,dblClickChange:{type:"text"}       },
        "layui-inline":{name:"行内区域",canZoom:true,assistZoom:true,   dragInto:true, duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,  assistDelete:true,  canDelete:true,dblClickChange:{type:"text"}      },
        "layui-input-inline":{name:"输入行内",canZoom:true,assistZoom:true,   dragInto:true, duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,assistDelete:true,    canDelete:true,dblClickChange:{type:"text"}       },
        "layui-form-mid":{name:"极小区域",   dragInto:true, duplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,dblClickChange:{type:"text"}      },
        ...
        "layui-container":{name:"屏幕居中",canZoom:true,assistZoom:true,   dragInto:true, duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,  assistDelete:true,  canDelete:true,dblClickChange:{type:"text"}      },
        "layui-fluid":{name:"屏幕自适应",canZoom:true,assistZoom:true,   dragInto:true, duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,  assistDelete:true,  canDelete:true,dblClickChange:{type:"text"}     },
        ...
        "magicalcoder-tab-title":{name:"标签标题",treeExtraName:{attr:[],text:true},   dragInto:false, duplicate:false,duplicateAttr:[],         copy:false,      paste:false,    canDelete:true,dblClickChange:{type:"text"}     },
        ...
        "layui-tab-item":{name:"标签面板",canZoom:true,assistZoom:true,   dragInto:true, duplicate:false,duplicateAttr:[],         copy:false,      paste:true,    canDelete:true,dblClickChange:{type:'text'}      },
        ...
        "layui-colla-title":{name:"折叠标题",treeExtraName:{attr:[],text:true},   dragInto:false, duplicate:false,duplicateAttr:[],         copy:false,      paste:false,    canDelete:false,onlyParents:["layui-colla-item"],dblClickChange:{type:"text"}     },
        "layui-colla-content":{name:"折叠面板",   dragInto:true, duplicate:false,duplicateAttr:[],         copy:false,      paste:true,    canDelete:false,onlyParents:["layui-colla-item"],dblClickChange:{type:"text"}      },

        "layui-elem-quote":{name:"段落引用",   dragInto:true, duplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true ,dblClickChange:{type:"text"}     },
        ...
        "legend":{name:"字段集标题",   dragInto:false, duplicate:false,duplicateAttr:[],         copy:false,      paste:false,    canDelete:false,onlyParents:["layui-elem-field"]  ,dblClickChange:{type:"text"}   },
        "layui-field-box":{name:"字段集面板",   dragInto:true, duplicate:false,duplicateAttr:[],         copy:false,      paste:true,    canDelete:false,onlyParents:["layui-elem-field"] ,dblClickChange:{type:"text"}     },
        ...
        "layui-badge-dot":{name:"圆点徽章",dragInto:false,duplicate:true, copy:true,      paste:false,    canDelete:true,dblClickChange:{type:"text"}},
        ...
        "layui-card-header":{name:"卡片头",   dragInto:false, duplicate:false,duplicateAttr:[],         copy:false,      paste:false,    canDelete:false,onlyParents:["layui-card"] ,dblClickChange:{type:"text"} ,afterResize:{widthWucha:true}   },
        "layui-card-body":{name:"卡片体",canZoom:true,assistZoom:true,   dragInto:true, duplicate:false,duplicateAttr:[],         copy:false,      paste:true,    canDelete:false,onlyParents:["layui-card"]    ,afterResize:{widthWucha:true}  },
        ...
        "label":    {primary:0,name:"标签",dragInto:false,  duplicate:true,duplicateAttr:[],       copy:true,      paste:false,  canDelete:true,dblClickChange:{type:"text"}    },
        "i":    {primary:0,name:"图标文字",dragInto:false,  duplicate:true,duplicateAttr:[],       copy:true,      paste:false,  canDelete:true,dblClickChange:{type:"text"}    },
        "p":    {name:"段落1",dragInto:false,  duplicate:true,duplicateAttr:[],   copy:true,       paste:true,  canDelete:true,dblClickChange:{type:"text"}    },
