...
function Constant(){
    ...
    */
    this.tagClassMapping = {
        ...
        "van-button":        {name:"按钮",treeExtraName:{attr:[],text:true},     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true ,dblClickChange:{type:"text"}      },
        ...
        "van-col":           {name:"列",canZoom:true,assistZoom:true,       dragInto:true,       duplicate:true,assistDuplicate:true,duplicateAttr:[],        copy:false,      paste:true,  canDelete:true,assistDelete:true,onlyParents:["van-row"] ,bind:{"v-text":'""',"v-html":'""',"v-for":"[]"}  ,dblClickChange:{type:"text"}  },
        ...
        "van-checkbox":      {name:"复选框",treeExtraName:{attr:[],text:true},    dragInto:false,     duplicate:true,duplicateAttr:["name"],         copy:true,      paste:false,   canDelete:true,     onlyParents:["van-checkbox-group"], dblClickChange:{type:'text'}},
        ...
        //标签页
        "van-tabs":{name:"标签页",canZoom:true,assistZoom:true,assistDelete:true,assistAdd:true,assistDuplicate:true,dragInto:false,duplicate:true,duplicateAttr:[],copy:true,paste:false, canDelete:true,onlyChildren:["van-tab"],addOneItems:[{"":[{html:"<van-tab></van-tab>",focus:false}]}],bind:{"v-model":"0",}     },
        "van-tab":{name:"标签",canZoom:true,assistZoom:true,dragInto:true,duplicate:true,duplicateAttr:[],copy:false,paste:true, canDelete:true,assistDelete:true,onlyParents:["van-tabs"], dblClickChange:{type:"attr",attrName:"title"}},
        //标签栏
        ...
        "van-radio":{name:"单选",canZoom:true,assistZoom:true,dragInto:false,duplicate:true,duplicateAttr:["name"],copy:false,paste:true, canDelete:true,assistDelete:true,onlyParents:["van-radio-group"], dblClickChange:{type:"text"}},
        //下拉菜单
...
//Contact联系人{
            ...
            },
            {
                ...
                content:{
                    "van-password-input":[
                       {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'密码值',    attrName:'value',extendKey:"variable"},
                    ],
                     "van-field":[
                       {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前输入的值',attrName:'v-model',extendKey:"variable"},
                    ],
                    "van-datetime-picker":[
                       {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前日期',attrName:'v-model',extendKey:"variable"},
                       {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'最小日期',attrName:':min-date',extendKey:"variable"},
                       {type:this.type.TEXT,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'最大日期',attrName:':min-date',extendKey:"variable"},
                       {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'可选的最小小时',attrName:':min-hour',extra:{min:0,max:23},extendKey:"variable"},
                       {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'可选的最大小时',attrName:':max-hour',extra:{min:0,max:23},extendKey:"variable"},
                       {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'可选的最小分钟',attrName:':min-minute',extra:{min:0,max:59},extendKey:"variable"},
                       {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'可选的最大分钟',attrName:':max-minute',extra:{min:0,max:59},extendKey:"variable"},
                    ],
                    //单元格 "van-cell"
                    "van-cell":[
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'左侧标题额外样式',    attrName:'title-style',extendKey:"variable"},
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'左侧标题额外类名',    attrName:'title-class',extendKey:"variable"},
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'右侧内容额外类名',    attrName:'value-class',extendKey:"variable"},
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'描述信息额外类名',    attrName:'label-class',extendKey:"variable"},
                    ],
//弹出层
                    "van-popup":[
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'自定义遮罩层样式',    attrName:'overlay-style',extendKey:"variable"},
                    ],
//日历
                    "van-calendar":[
                        {type:this.type.TEXT,    clearAttr:true,    oneLine:true,    change:this.change.ATTR,    title:'日历标题',    attrName:'close-icon',extend:true,extendKey:'icon',extendKey:"variable"},
                    ],
                    //地址列表
                    "van-address-list":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前选中地址的 id',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'地址列表',attrName:':list',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'不可配送地址列表',attrName:':disabled-list',extendKey:"variable"},
                    ],
//地址编辑
                    "van-address-edit":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'地区列表',attrName:':area-list',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'收货人信息初始值',attrName:'address-info',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'详细地址搜索结果',attrName:':search-result',extendKey:"variable"},
                    ],
//联系人列表
                    "van-contact-list":[
...
//联系人编辑
                    "van-contact-edit":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'联系人信息',attrName:':contact-info',extendKey:"variable"},
                    ],
//Coupon 优惠券选择器   单元格
                    "van-coupon-cell":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'可用优惠券列表',attrName:':coupons',extendKey:"variable"},
                    ],
//Coupon 优惠券选择器  列表
                    "van-coupon-list":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'可用优惠券列表',attrName:':coupons',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'不可用优惠券列表',attrName:':disabled-coupons',extendKey:"variable"},
                    ],
//Pagination分页
                    "van-pagination":[
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前页码',attrName:'v-model',extra:{min:0,max:20000},extendKey:"variable"},
                    ],
//Sku 商品规格
                    "van-sku":[
                        {type:this.type.CHECKBOX,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'状态',options:[{n:"v-model",t:"显示sku",c:true,u:false}],extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'商品sku数据',attrName:':sku',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'商品信息',attrName:':goods',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'步进器相关自定义配置',attrName:':custom-stepper-config',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'留言相关配置',attrName:':message-config',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'商品属性',attrName:'properties',extendKey:"variable"},
                    ],
//SwitchCell 开关单元格
                    "van-switch-cell":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'开关状态',attrName:'v-model',extendKey:"variable"},
                    ],
                    //GoodsAction 商品导航
                    "van-goods-action-icon":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'图标额外类名',attrName:'icon-class',extendKey:"variable"},
                    ],
//TreeSelect 分类选择
                    "van-tree-select":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'分类显示所需的数据',attrName:':items',extendKey:"variable"},
                    ],
                    //Tabbar 标签栏
                    "van-tabbar":[
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前选中标签的名称或索引值',attrName:'v-model',extra:{min:0,max:20000},extendKey:"variable"},
                    ],
//Tab 标签页
                    "van-tabs":[
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'绑定当前选中标签的标识符',attrName:'v-model',extra:{min:0,max:20000},extendKey:"variable"},
                    ],
                    "van-tab":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义标题样式',attrName:'title-style',extendKey:"variable"},
                    ],
//Sidebar 侧边导航
                    "van-sidebar":[
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前导航项的索引',attrName:'v-model',extra:{min:0,max:20000},extendKey:"variable"},
                    ],
//省市区选择
                    "van-area":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'省市区数据，格式见下方',attrName:':area-list',extendKey:"variable"},
                    ],
//Radio 单选框
                    "van-radio-group":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前选中项的标识符',attrName:'v-model',extendKey:"variable"},
                    ],

//Rate 评分
                    "van-rate":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前分值',attrName:'v-model',extendKey:"variable"},
                    ],
                    "van-search":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前值',attrName:'v-model',extendKey:"variable"},
                    ],
                    "van-slider":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前值',attrName:'v-model',extendKey:"variable"},
                    ],
//Stepper 步进器
                    "van-stepper":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前输入的值',attrName:'v-model',extendKey:"variable"},
                    ],
//Switch 开关
                    "van-switch":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'开关选中状态',attrName:'v-model',extendKey:"variable"},

                    ],
//Uploader 文件上传
                    "van-uploader":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'文件列表',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'文件读取完成后的回调函数',attrName:':after-read',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'文件读取前的回调函数',tooltip:"返回false可终止文件读取,支持返回Promise",attrName:':before-read',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'文件删除前的回调函数',tooltip:"返回false可终止文件读取，支持返回Promise",attrName:':before-delete',extendKey:"variable"},
                    ],
//ActionSheet 上拉菜单
                    "van-action-sheet":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'是否显示',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'菜单选项',attrName:':actions',extendKey:"variable"},
                    ],
                    "van-overlay":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'是否显示',attrName:':show',extendKey:"variable"},
                    ],
//Overlay 遮罩层
                    "van-button":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义样式',attrName:'custom-style',extendKey:"variable"},
                    ],
//PullRefresh 下拉刷新
                    "van-pull-refresh":[
...
// Dialog 弹出框
                    ...
                    "van-count-down": [
                        {type: this.type.TEXT,clearAttr: true,oneLine: true,change: this.change.ATTR,title: '倒计时时长，单位毫秒',attrName: ':time',extendKey:"variable"},
                    ],
////DropdownMenu 下拉菜单
                    "van-dropdown-item":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'值',attrName:'v-model',extendKey:"variable"},
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'选项数组',attrName:':options',extendKey:"variable"},
                    ],
                    /*weipeng*/
                    "van-collapse":[
                        {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'当前展开面板的 name',attrName:'v-model',extendKey:"variable"},
                    ],
                    "van-list":[
                    ...
                    "van-steps":[
                        {type:this.type.SLIDER,clearAttr:true,oneLine:false,change:this.change.ATTR,title:'当前步骤',attrName:':active',extra:{min:0,max:20000},extendKey:"variable"},
                    ],
                    "van-image-preview":[ {type:this.type.TEXT,clearAttr:true,oneLine:true,change:this.change.ATTR,title:'自定义类名',attrName:'class-name',extendKey:"variable"},
                    ],
                }
            },
            {
